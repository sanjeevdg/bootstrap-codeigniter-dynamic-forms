...
var styleSwitcher = {
    init: function () {
        ...
        yepnope([
        {
            load: 'http://localhost/version2/assets/css/style-switcher.css'
        },
        {
            load: 'http://localhost/version2/assets/lib/colorpicker/css/colorpicker.css'
        },
        {
            load: 'http://localhost/version2/assets/lib/cssbeautify/cssbeautify.js'
        },
        {
            load: 'http://localhost/version2/assets/lib/colorpicker/js/bootstrap-colorpicker.js',
            complete: function () {
                yepnope([
                {
                    load: 'less!http://localhost/version2/assets/less/theme.less'
                },
                {
                    load: 'http://localhost/version2/assets/lib/less-1.6.1.min.js',
                    complete: function () {
                        $this.build();
