...
var styleSwitcher = {
    init: function () {
        ...
        yepnope([
        {
            load: 'http://codefinder.byethost13.com/version2/assets/css/style-switcher.css'
        },
        {
            load: 'http://codefinder.byethost13.com/version2/assets/lib/colorpicker/css/colorpicker.css'
        },
        {
            load: 'http://codefinder.byethost13.com/version2/assets/lib/cssbeautify/cssbeautify.js'
        },
        {
            load: 'http://codefinder.byethost13.com/version2/assets/lib/colorpicker/js/bootstrap-colorpicker.js',
            complete: function () {
                yepnope([
                {
                    load: 'less!http://codefinder.byethost13.com/version2/assets/less/theme.less'
                },
                {
                    load: 'http://codefinder.byethost13.com/version2/assets/lib/less-1.6.1.min.js',
                    complete: function () {
                        $this.build();
    ...
    build: function () {
        ...
        if (localStor) {
            ...
            if (localStorage.pattern) {
                $('body') .css({
                    'background': 'url(http://codefinder.byethost13.com/version2/assets/img/pattern/' + localStorage.pattern + '.png) repeat'
                });
            }
        }
