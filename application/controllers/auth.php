	...
	function login()
	{
		...
		if ($this->form_validation->run() == true)
		{
			...
			if ($this->ion_auth->login($this->input->post('identity'), $this->input->post('password'), $remember))
			{
				...
				$str = "<div class='alert alert-link' id='my_alert_div'>
							<button type='button' class='close' data-dismiss='alert'>×</button>
							<strong>".$this->ion_auth->messages()."</strong>
...
$str = "<div class='alert alert-success' id='my_alert_div'>
				...
				$this->session->set_flashdata('message', $str);
				redirect(site_url('members/dashboard'), 'refresh'); 
			}
			}
			else
			{
			...
			$str = "<div class='alert alert-error' id='my_alert_div'>
							<button type='button' class='close' data-dismiss='alert'>×</button>
							<strong>".$this->ion_auth->errors()."</strong>
						</div><script> $('#my_alert_div').fadeOut(3000); </script>";				
